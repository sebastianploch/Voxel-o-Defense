...
#define NullType NULLTYPE, 4, 1, 2, false, ONE
#define Zombie ZOMBIE, 4, 1, 2, false, ONE
#define Spider SPIDER, 4, 1, 2, false, FIVE
#define Skeleton SKELETON, 4, 1, 2, false, ONE
