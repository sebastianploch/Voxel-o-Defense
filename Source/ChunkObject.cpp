...
// Init Static Buffers
void ChunkObject::InitBuffers(ID3D11Device* device) {
	// Vertex Buffer
	...
	sBd.pSysMem = ChunkObject::s_cubeVertices;
	...
	sIbd.pSysMem = ChunkObject::s_cubeIndices;
...
void ChunkObject::InitDebugTexture(const wchar_t* texturePath, ID3D11Device* device) {
...
Microsoft::WRL::ComPtr<ID3D11Buffer> ChunkObject::s_cubeVertexBuffer;

Microsoft::WRL::ComPtr<ID3D11Buffer> ChunkObject::s_cubeIndexBuffer;

Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> ChunkObject::s_debugTexture;

Vertex ChunkObject::s_cubeVertices[24] =
{
...
WORD ChunkObject::s_cubeIndices[36] =
{
	3, 1, 0,
	2, 1, 3,
